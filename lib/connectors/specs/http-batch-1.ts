 ...
 * lib/connectors/{salesforce,segment,klaviyo,sendgrid,auth0,clerk,
 * posthog,zendesk,mixpanel}.ts.
 * (Intercom lives in v2's core HTTP_SPECS already and is not repeated here.)
 *
 * Conversions mirror http-batch-0.ts exactly. Three connectors
 * (auth0, clerk, zendesk) reduce cleanly to a single
